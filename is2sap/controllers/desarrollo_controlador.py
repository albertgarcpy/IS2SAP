...
#from tgext.desa.tgadminconfig import TGAdminConfig
...
#from is2sap.controllers.item_controlador import LineaBaseController
...
class DesarrolloController(TGController):
    ...
    allow_only = has_permission('desarrollo',
                                msg=l_('Solo para usuarios con permiso "desarrollo"'))
    default_index_template = "genshi:is2sap.templates.desa"

    def __init__(self, models, session, config_type=None, translations=None):
        super(DesarrolloController, self).__init__()
    ...
    @with_trailing_slash
    @expose('tgext.desa.templates.index')
    def index(self):
